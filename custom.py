...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 2  # Background + Hard_hat, Safety_vest
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        # Add classes. We have only one class to add.
        self.add_class("object", 1, "pothole")
...
def train(model):
    ...
    dataset_train.load_custom("D:/maskrcnn/dataset", "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("D:/maskrcnn/dataset", "val")
    dataset_val.prepare()
