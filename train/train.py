...
for d in ["train", "val"]:
    DatasetCatalog.register("../dataset/pothole_" + d, lambda d=d: get_dicts(os.path.join("../dataset/pothole", d)))
    MetadataCatalog.get("../dataset/pothole_" + d).set(thing_classes=["pothole"])
pothole_metadata = MetadataCatalog.get("../dataset/pothole_train")


dataset_dicts = get_dicts("../dataset/pothole/train")
...
cfg = get_cfg()
cfg.merge_from_file(model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml"))
cfg.DATASETS.TRAIN = ("../dataset/pothole_train",)
cfg.DATASETS.TEST = ()
